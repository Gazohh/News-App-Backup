...
<center>
 ...
 padding: 0'><span style="text-transform:uppercase">Geverifieerd</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Je email($email) is succesvol geverifieerd!<br> Nu weten we zeker dat jij het bent ;)
                                                    <br>
                                                </td>
                                            </tr>
                                            </tbody>
